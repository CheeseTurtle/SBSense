...
app.DataTable{1}(:,:) = [];
app.DataTable{2}(:,:) = [];
app.DataTable{1} = addvars(addvars(removevars(app.DataTable{1}, {'PSZP', 'PSZW', 'CFBL', 'CFBR', 'ResNorm', 'PeakLoc', 'PeakHgt'}), ...
    ...
    'NewVariableNames', {'PeakLoc', 'PeakHgt'}), ...
        ...
        'After', 'PSB', 'NewVariableNames', {'PSZP', 'PSZW', 'CFBL', 'CFBR', 'ResNorm'});
app.DataTable{2} = addvars(addvars(removevars(app.DataTable{2}, {'PSZP', 'PSZW', 'CFBL', 'CFBR', 'ResNorm', 'PeakLoc', 'PeakHgt'}), ...
    NaN(0,app.NumChannels, 'double'), NaN(0,app.NumChannels, 'double'), ...
    'NewVariableNames', {'PeakLoc', 'PeakHgt'}), ...
    uint16.empty(0,app.NumChannels), uint16.empty(0,app.NumChannels), ...
    double.empty(0,app.NumChannels), double.empty(0,app.NumChannels), ...
...
app.BinFileCollection = sbsense.BinFileCollection( ...
    ...
    "tmpdata", ... % app.fdm, ...
    [app.AnalysisParams.EffectiveHeight, ...
